...
const { runAgent }             = require('./utils/fredAgent');
...
// ---------------------------------------------------------------------------
// Chat — respond when @mentioned via the Fred agentic runner
// ---------------------------------------------------------------------------
...
client.on('messageCreate', async (message) => {
  ...
  // Upload wizard — handles file attachments and multi-step follow-up replies
  ...
  try {
    const reply = await runAgent(message, db, client);
